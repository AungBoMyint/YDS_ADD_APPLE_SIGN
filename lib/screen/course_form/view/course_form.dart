...
class _ChildTextFieldWidgetState extends State<ChildTextFieldWidget> {
  ...
  void initState() {
    super.initState();
    _controller.inputMap
        .putIfAbsent(widget.fieldKey, () => TextEditingController());
  }

  @override
  Widget build(BuildContext context) {
    final error = _controller.validate(widget.hintText, widget.fieldKey,
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    disabledBorder: OutlineInputBorder(
                      ...
                      width: 2,
                      color: _controller.checkHasError(widget.fieldKey,
                              _controller.inputMap[widget.fieldKey]?.text)
                          ? Colors.red
                          : Colors.black,
                    )),
          ...
          child: SfDateRangePickerTheme(
            ...
            child: SfDateRangePicker(
              ...
              onSelectionChanged: (args) =>
                  _controller.setSelectedDateTime(args.value as DateTime),
            ),
          ),
        ),
      ]),
